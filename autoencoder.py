...
def init_autoencoder(noise_sigma, innerLen, outerLen, learning_rate=0.01):
    ...
    encoder = keras.models.Sequential([encoder_input, encoder_output1, encoder_output2,
    ...
    decoder = keras.models.Sequential([decoder_input, decoder_output1, decoder_output2,
...
def train_autoencoder(nEpochs, BatchSize, learning_rate, lr_scheduler, SampleData, autoencoder):
    ...
    for epoch in range(nEpochs):
        ...
        epoch_loss = 0.0
        # 更新学习率
        learning_rate = keras.backend.get_value(
            autoencoder.optimizer.learning_rate)
        learning_rate = lr_scheduler(epoch, learning_rate)
        keras.backend.set_value(
            autoencoder.optimizer.learning_rate, learning_rate)
