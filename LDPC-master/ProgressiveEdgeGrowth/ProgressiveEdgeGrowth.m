function H = ProgressiveEdgeGrowth(N, M, Dv, DoYouWantACE)%Random PEG. If you want add ACE improvement, just set 'DoYouWantACE = 1'.
H = zeros(M, N, 'double');%Unsigned integer 8 is not enough.
